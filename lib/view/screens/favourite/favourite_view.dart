        ...
        body: Stack(
          children: [
            RefreshIndicator(
              onRefresh: () async {},
              child: FutureBuilder(
                future: context.read(favouriteViewModelProvider).loadFavourites(),
                builder: (context, snapshot) {
                  ...
                  return favouriteModel.data.favouriteData.length == 0
                    ...
                    child: GridView.builder(
                      itemCount: favouriteModel.data.favouriteData.length,
                      shrinkWrap: true,
                      primary: true,
                          ...
                          child: GestureDetector(
                            ...
                            child: GridTile(
                              child: Stack(
                                children: [
                                  CachedNetworkImage(
                                    imageUrl: favouriteModel.data.favouriteData[index].product.image,
                              ...
                              footer: GridTileBar(
                                ...
                                title: Text(
                                  favouriteModel.data.favouriteData[index].product.name,
